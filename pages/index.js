...
export default function Home({ rol, cerrarSesion }) {
  ...
  const tipoHistorial={ingreso:'🟢',salida:'🔴',movimiento:'🔵',reingreso:'🟡',estado:'⚪',prueba:'🟠',motor:'🔧',terceros:'⏳',repuestos:'📦',aprobacion:'✍️',elevador:'🅿️',diagnostico:'🔍',reparacion:'🛠️',diagnostico_fin:'✅',cliente_aprobo:'👍',cliente_pago:'💵',oficina_salio:'🚗',repuestos_llegaron:'📦',repuesto_no_pactado:'⚠️',mecanico_pide_repuestos:'🔧',trabajo_iniciado:'▶️',service:'🛢️'}

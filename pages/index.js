              ...
              <div>
                <div className={styles.card}>
                  ...
                  <div className={styles.formGrid}>
                    ...
                    <div className={styles.formGroup}><label>Patente</label><input value={formChecklist.patente} {...patenteHandlers(formChecklist.patente,v=>setFormChecklist({...formChecklist,patente:v}))} placeholder="AB 123 CD"/></div>

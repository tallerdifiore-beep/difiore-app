              ...
              <div>
                <div className={styles.card}>
                  ...
                  <div className={styles.formGrid}>
                    ...
                    <div className={styles.formGroup}><label>Patente</label><input value={formChecklist.patente} onChange={e=>setFormChecklist({...formChecklist,patente:formatPatente(e.target.value,formChecklist.patente,e.target.selectionStart)})} placeholder="AB 123 CD"/></div>
